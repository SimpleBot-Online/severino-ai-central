    ...
    <header className="bg-card border-b border-border py-4 px-6 flex items-center justify-between">
      <div className="flex items-center">
        <button
          ...
          className="text-foreground hover:text-primary mr-4 focus:outline-none md:hidden"
        ...
        <div className="flex items-center gap-2">
          <img
            alt="Severino Logo"
            src="/lovable-uploads/b78248f0-9127-4245-8146-41531235c56f.png"
            className="h-8 w-8 object-cover"
          />
          <h1 className="text-xl font-semibold md:block hidden">DashBoard</h1>
        </div>
      </div>
